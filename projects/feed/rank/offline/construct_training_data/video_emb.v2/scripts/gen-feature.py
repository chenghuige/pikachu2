...
def parse(line):
    try:
        ...
        # output  here, click here must be in pos 2 for dedup
        line = "\t".join([mid, docid, click, product, abtestid, show_time, unlike, all_interest_cnt, ty, dur, user_show, ori_lr_score, lr_score] + \
