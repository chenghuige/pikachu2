...
cloud_root="/search/odin/publicData/CloudS/${user}/rank"
field_index_file="chg/rank/conf/${types[$((MARK))]}/fields.txt"
local_tfrecords_data_dir="${cloud_root}/data/${model_name}"
local_featindex_dir="${local_root}/data/${model_name}/feature_indexes"
...
gen_feature_output_utf8_2="${gen_feature_output_dir}/.utf8_2/${start_hour}"
