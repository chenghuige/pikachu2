...
#export DIR=$base_dir
export DIR=/home/gezi/tmp/rank/data/video_hour_sgsapp_v1
...
model=WideDeep
python ./train.py \
    --restore_exclude=global_step,ignore,learning_rate,dense_1,dense_2 \
    --hash_encoding=1 \
