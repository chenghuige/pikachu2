...
def get_parser(parser=None):
    ...
    parser.add_argument('--train_data_dir', type=str, default='/search/odin/publicData/CloudS/yuwenmengke/rank_0804_so/shida/data/video_hour_shida_v1/ofrecords/2020062420',
                        help='data path')
    ...
    parser.add_argument('--data_part_num', type=int, default=50,
    ...
    parser.add_argument('--max_feat_len', type=int, default=138,
    ...
    parser.add_argument('--feature_dict_size', type=int, default=3000000,
                        help='Feature Dict Size')
    parser.add_argument('--field_size', type=int, default=121,
                        help='Field Size')
    parser.add_argument('--embedding_size', type=int, default=32,
                        help='Deep Embedding Size')
    parser.add_argument('--deep_layers', type=list, default=[3872, 256, 50],
                        help='Deep FC layers')
    ...
    parser.add_argument('--predict_data_dir', type=str, default='/search/odin/publicData/CloudS/yuwenmengke/rank_0804_so/shida/data/video_hour_shida_v1/ofrecords/2020062422',
                        help='data path')
    parser.add_argument('--predict_model_path', type=str,
                        default='/dataset/wide_n_deep/models/snapshot_90001', help='')
    parser.add_argument('--predict_data_part_num', type=int, default=50,
