...
class Wide(object):
    ...
    def forward(self, features):
        ...
        feat_fields = features['feat_fields']
        feat_values = features['feat_values']
...
class Deep(object):
    ...
    def forward(self, features):
        feat_ids = features['feat_ids']
        feat_masks = features['feat_masks']
        feat_fields = features['feat_fields']
        ...
        feat_masks = flow.reshape(feat_masks, [-1, self.max_feat_len, 1])
        feat_embeddings = feat_masks * feat_embeddings
        ...
        for i in range(1, len(self.deep_layers)):
            ...
            deep_h_o = flow.keras.activations.relu(deep_h_o)
