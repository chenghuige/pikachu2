...
def build_fpn(
    ...
    x = backbone.output
    # add dorpout here 20201130 需要再确认是否比之前效果好 TODO 参考unet影响效果
    ...
    gezi.set('seg_notop', models.Model(input_, x, name=f'sm-fpn-{backbone_name}_notop'))
    notop_out = x
    ...
    model = models.Model(input_, [x, notop_out], name=f'sm-fpn-{backbone_name}')
