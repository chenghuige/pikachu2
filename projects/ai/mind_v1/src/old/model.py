...
class Encoder(keras.Model):
  def __init__(self, emb, encoder=None, pooling=None, **kwargs):
...
class SeqsEncoder(keras.Model):
  def __init__(self, encoder, seqs_encoder=None, pooling=None,  **kwargs):
...
class Model(mt.Model):
  def __init__(self, **kwargs):
    ...
    self.title_encoder = Encoder(self.word_emb, FLAGS.seqs_encoder, FLAGS.pooling, name='title_encoder')
    ...
    self.abstract_encoder = Encoder(self.word_emb, FLAGS.seqs_encoder,name='abstract_encoder')
    self.abstracts_encoder = SeqsEncoder(self.abstract_encoder, FLAGS.seqs_encoder, FLAGS.seqs_pooling, name='abstracts_encoder')

    self.body_encoder = Encoder(self.word_emb,  None, FLAGS.pooling, name='body_encoder')
    ...
    #self.bert_encoder = mt.models.Bert(FLAGS.bert_dir, FLAGS.emb_size, max_input_length=max_input_length, 
    ...
    #self.bert_seqs_encoder = SeqsEncoder(self.bert_encoder, None, FLAGS.seqs_pooling, name='bert_seqs_encoder')
  ...
  def call(self, input):
    ...
    if FLAGS.use_impression_titles:
