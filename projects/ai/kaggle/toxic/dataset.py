...
class Dataset(melt.tfrecords.Dataset):
  ...
  def parser(self, example):
    ...
    features_dict = {
      ...
      'comment_str':  tf.io.FixedLenFeature([], tf.string),
      'comment_tokens_str':  tf.io.FixedLenFeature([], tf.string),
        comment_key: tf.io.VarLenFeature(tf.int64),
      'comment_chars':  tf.io.VarLenFeature(tf.int64),
      'comment_ngrams': tf.io.VarLenFeature(tf.int64),
      #'comment_fngrams': tf.VarLenFeature(tf.int64),
      'simple_chars':  tf.io.VarLenFeature(tf.int64),
      #'simple_ngrams': tf.VarLenFeature(tf.int64),
      'tokens_info': tf.io.VarLenFeature(tf.float32),
      ...
      'classes': tf.io.FixedLenFeature([NUM_CLASSES], tf.float32),
