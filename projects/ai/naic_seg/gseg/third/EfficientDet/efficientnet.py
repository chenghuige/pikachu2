...
from efficientnet.weights import IMAGENET_WEIGHTS_PATH, IMAGENET_WEIGHTS_HASHES, NS_WEIGHTS_HASHES, NS_WEIGHTS_PATH
...
def EfficientNet(width_coefficient,
    ...
    # Load weights.
    melt.l2_info(model, 'before loading effnet backbone:')
    if weights == 'imagenet':
    ...
    melt.l2_info(model, 'after loading effnet backbone:')
