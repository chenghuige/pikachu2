...
class MultinomialEmbeddingHelper(Helper):
  ...
  def sample(self, time, outputs, state, name=None):
    ...
    sample_ids = tf.random.categorical(logits=outputs, num_samples=1)
